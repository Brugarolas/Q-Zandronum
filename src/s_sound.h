...
void S_Sound (AActor *ent, int channel, FSoundID sfxid, float volume, float attenuation, bool bSoundOnClient = false, AActor *activator = NULL, bool bSkipActivatorClient = false, bool bIsFromACS = false); // [EP] Added bSoundOnClient.
...
#define CHAN_LOCAL				16384// only plays locally for the calling actor
...
void S_StopSound (AActor *ent, int channel, AActor *activator = NULL, bool bSkipActivatorClient = false, bool bIsFromACS = false);
